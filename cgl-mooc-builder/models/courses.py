...
# 'ReviewAssessmentExample': 30, 'ReviewAssessmentExample2': 30
DEFAULT_LEGACY_ASSESSMENT_WEIGHTS = {'Pre': 0, 'Mid': 0, 'Fin': 0, 'Survey': 100}
...
LEGACY_REVIEW_ASSESSMENT_LIST = [
    'Peer_review_Homework_2.1','Peer_review_Homework_2.2','Peer_review_Homework_2.3',
    'Peer_review_Homework_4.1','Peer_review_Homework_4.2',
    'Peer_review_Homework_6.1',
    'Peer_review_Homework_7.1','Peer_review_Homework_7.2',
    'Peer_review_Homework_8.1','Peer_review_Homework_8.2',
    'Peer_review_Homework_9.1','Peer_review_Homework_9.2',
    'Peer_review_Homework_10.1',
    'Peer_review_Homework_11.1',
    'Peer_review_Homework_12.1',
    'Peer_review_Mid',
    'Peer_review_Final']
...
LEGACY_HUMAN_GRADER_WORKFLOW = yaml.safe_dump({
    ...
    SUBMISSION_DUE_DATE_KEY: '9999-01-01 12:00',
    REVIEW_DUE_DATE_KEY: '9999-12-01 12:00',
...
class Unit12(object):
    ...
    def workflow_yaml(self):
        ...
        if self.unit_id == LEGACY_REVIEW_ASSESSMENT or (self.unit_id in LEGACY_REVIEW_ASSESSMENT_LIST):
    ...
    def get_all_scores(self, student):
        ...
        for unit in assessment_list:
            ...
            if completed and self.needs_human_grader(unit):
                reviews = self.get_reviews_processor().get_review_steps_by(unit.unit_id, student.get_key())
                review_min_count = unit.workflow.get_review_min_count()
                if not review.ReviewUtils.has_completed_enough_reviews(reviews, review_min_count):
                    completed = False
