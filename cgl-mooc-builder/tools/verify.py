...
class Unit(object):
    ...
    def list_properties(self, name, output):
        ...
        output.append('%s[\'section_overview\'] = %s;' % ( #section_overview
            name, str(self.section_overview).lower()))
